...
public class KesfetDetails {
   ...
   public String downloadUrl,parcaAdi,aciklama,puan,gonderiId,gonderenId,parcaModeli,ayrıParca;
   Timestamp tarih;
   int BegeniSayisi;

    public KesfetDetails(String downloadUrl, String parcaAdi, String aciklama, String puan, String gonderiId, String gonderenId, String parcaModeli, String ayrıParca, Timestamp tarih, int begeniSayisi) {
