package com.app.kutaykerem.productdiscovery.Adaptor.ProductDetails;
...
import com.app.kutaykerem.productdiscovery.Models.ProductDetails;
...
public class AdaptorProductDetails extends RecyclerView.Adapter<AdaptorProductDetails.HolderAnakart> {
    ...
    public AdaptorProductDetails(ArrayList<ProductDetails> productDetailsArrayList, Context context) {
        this.productDetailsArrayList = productDetailsArrayList;
        this.context = context;

    }
    public void setPcDetailsArrayList(ArrayList<ProductDetails> productDetailsArrayList) {
        this.productDetailsArrayList = productDetailsArrayList;
    }
    ...
    public void onBindViewHolder(@NonNull HolderAnakart holder, int position) {
        holder.parcaAdi.setText(productDetailsArrayList.get(position).getName());
        holder.parcaModeli.setText(productDetailsArrayList.get(position).getDetailsName());
