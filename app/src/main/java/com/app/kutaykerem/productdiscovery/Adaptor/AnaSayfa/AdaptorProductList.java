...
public class AdaptorProductList extends RecyclerView.Adapter<AdaptorProductList.Holder> {
    ...
    public AdaptorProductList(Context context, List<PcNames> pcNamesArrayList) {
