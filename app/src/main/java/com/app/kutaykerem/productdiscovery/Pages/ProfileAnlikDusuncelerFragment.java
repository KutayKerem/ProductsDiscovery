...
import com.app.kutaykerem.productdiscovery.Adaptor.Profile.AdapterAnlikDusunceler;
import com.app.kutaykerem.productdiscovery.R;
import com.app.kutaykerem.productdiscovery.databinding.FragmentProfileAnlikDusuncelerBinding;
...
public class ProfileAnlikDusuncelerFragment extends Fragment {

    FragmentProfileAnlikDusuncelerBinding binding;

    ArrayList<KesfetAnlıkDusuncelerDetails> anlıkDusuncelerDetailsArrayList;
    AdapterAnlikDusunceler adapterAnlikDusunceler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      binding = FragmentProfileAnlikDusuncelerBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        anlıkDusuncelerDetailsArrayList = new ArrayList<>();
    ...
    public void showText(String id) {
        ...
        ids = id;
       // AnlikDusunce
        firebaseFirestore.collection("Kesfet").document("AnlıkDüsünce")
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                if (value != null) {
                    anlıkDusuncelerDetailsArrayList.clear();
                    for (DocumentSnapshot snapshot : value.getDocuments()) {
                        ...
                        anlıkDusuncelerDetailsArrayList.add(kesfetAnlıkDusuncelerDetails);

                    }
                    binding.mRecyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
                    adapterAnlikDusunceler = new AdapterAnlikDusunceler(requireContext(),anlıkDusuncelerDetailsArrayList);
                    binding.mRecyclerView.setAdapter(adapterAnlikDusunceler);
                    adapterAnlikDusunceler.notifyDataSetChanged();
    ...
    public void onResume() {
     ...
     try{
         binding.profilekesfetanlikDusuncelerSwipeResfresh.setColorSchemeResources(R.color.secilmeyenRenk);
         binding.profilekesfetanlikDusuncelerSwipeResfresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
             @Override
             public void onRefresh() {
                 System.out.println(ids);
                 showText(ids);
                 binding.profilekesfetanlikDusuncelerSwipeResfresh.setRefreshing(false);
             }
         });
     }catch (Exception e){
         e.printStackTrace();
